...
\begin{frame}[t]
  ...
  \note{\onslide<5->{\ExecuteMetaData[007-anares_notes.tex]{Objectifs}}}
  \note{\onslide<8->{\ExecuteMetaData[007-anares_notes.tex]{Environnement}}}
...
\begin{frame}[t]
  \slidetitle[Principe]
  \note{\onslide<1->{\ExecuteMetaData[007-anares_notes.tex]{MITM}}}
  \begin{figure}
    \vspace{-0.65cm}
    \input{mitm}
