  ...
  \begin{columns}
    ...
    \begin{column}{0.25\linewidth}     
     ...
     \begin{overlayarea}{0.6\linewidth}{\linewidth}
      ...
      \only<3-3|handout:0>{\includegraphics[width=\linewidth]{0_bugdroid-1.png}}
      \only<4-4|handout:0>{\includegraphics[width=\linewidth]{0_bugdroid-2.png}}
      \only<5-5|handout:0>{\includegraphics[width=\linewidth]{0_bugdroid-3.png}}
      \only<6-6|handout:0>{\includegraphics[width=\linewidth]{0_bugdroid-4.png}}
      \only<7-7|handout:0>{\includegraphics[width=\linewidth]{0_bugdroid-5.png}}
      \only<8-8|handout:0>{\includegraphics[width=\linewidth]{0_bugdroid-6.png}}
     \end{overlayarea}
    \end{column}
  \end{columns}
