...
\begin{tikzpicture}[scale=0.6, every node/.style={scale=0.6}, show background rectangle,background rectangle/.style={fill=backgroundColor},color=white,]
    \tikzstyle{myarrowsBack}=[thick, line width=1.7mm,-open triangle 90,
...
\node[inner sep=0,minimum size=0] at (1.5,-1.54) (CS) {}; % invisible node
...
\node[inner sep=0,minimum size=0] at (1.5,-5.04) (BJ1) {}; % invisible node
...
\node[inner sep=0,minimum size=0] at (7.5,-1.54) (CCSS) {}; % invisible node
...
\node[inner sep=0,minimum size=0] at (7.5,-5.04) (BJ1) {}; % invisible node
...
\node[inner sep=0,minimum size=0] at (7.5,-8.54) (BD1) {}; % invisible node
